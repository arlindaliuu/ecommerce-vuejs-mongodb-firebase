<template>
  <div class="relative w-full mb-72">
    <h1 ref="myElement" class="absolute text-green-900 z-[1] font-title md:top-1/3 top-[10%] font-extrabold flex text-[30px] md:text-[70px] whitespace-nowrap overflow-hidden">
    ...
    <div class="relative mx-5 md:mx-0 md:w-[500px] md:h-[500px] bg-transparent backdrop-blur-sm hover:backdrop-blur-2xl border  duration-200 -mt-72 z-10 md:left-[85%] transform md:-translate-x-[85%] m-auto shadow-xl flex flex-wrap">
